...
if(MINGW AND NOT SDL2PC_FOUND)
	set(SDL2_MINGW_LIBRARY mingw32)
	set(SDL2_MWINDOWS_OPTION -mwindows)
endif()
	...
	if(NOT TARGET SDL2::SDL2)
		...
		if(MINGW)
			...
			if(SDL2PC_LIBRARIES)
				...
				if(SDL2_MWINDOWS_OPTION)
					set_target_properties(SDL2::SDL2main
					PROPERTIES
					INTERFACE_COMPILE_OPTIONS ${SDL2_MWINDOWS_OPTION})
				endif()
			endif()
				set_target_properties(SDL2::SDL2main
				PROPERTIES
